...
<body class="bg-white text-black">
            ...
            <div id="overlayDefaultContent">
                ...
                <div class="overlay-section">
                    ...
                    <div class="space-y-0.5">
                        ...
                        <div class="overlay-item" tabindex="0" onclick="redirectSearch('{{ $r['from'] }}','{{ $r['to'] }}','{{ $r['fd'] }}','{{ $r['td'] }}')" onkeydown="if(event.key==='Enter')this.click()">
                ...
                <div class="overlay-section">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        ...
                        @endphp
                        @foreach($dests as $d)
                        <div class="overlay-item" tabindex="0" onclick="redirectSearch('Jakarta','{{ $d['name'] }}','CGK','{{ $d['code'] }}')" onkeydown="if(event.key==='Enter')this.click()">
                            <img src="{{ $d['img'] }}" alt="{{ $d['name'] }}" class="dest-thumb-sm" loading="lazy">
                            <div>
                                <p class="font-medium text-sm">{{ $d['name'] }} ({{ $d['code'] }})</p>
                ...
                <div class="overlay-section">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <a href="{{ route('customer.home') }}" class="overlay-item">
                        ...
                        @auth
                        <a href="{{ route('customer.bookings') }}" class="overlay-item">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-[72px]">
                ...
                <div class="hidden md:flex items-center gap-1">
                    <a href="{{ route('customer.home') }}" class="px-4 py-2 text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 rounded-full transition-all">Beranda</a>
                    <a href="{{ route('customer.flights.results') }}" class="px-4 py-2 text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 rounded-full transition-all">Cari Tiket</a>
                    <a href="{{ route('customer.promos') }}" class="px-4 py-2 text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 rounded-full transition-all">Promo</a>
                </div>
                <div class="flex items-center gap-1.5">
                    @guest
                        <a href="{{ route('login') }}" class="hidden sm:block px-5 py-2 text-sm font-semibold text-white hover:bg-white/10 rounded-full transition-all">Masuk</a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-blue-700">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        ...
                        <li><a href="{{ route('customer.home') }}" class="text-sm text-blue-200 hover:text-white transition-colors">Cari Penerbangan</a></li>
    ...
    (function() {
        ...
        window._airports = @json($airports ?? []);
