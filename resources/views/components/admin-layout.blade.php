        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('admin.airlines.index') }}"
                   class="nav-item {{ request()->routeIs('admin.airlines.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.airports.index') }}"
                   class="nav-item {{ request()->routeIs('admin.airports.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.airplanes.index') }}"
                   class="nav-item {{ request()->routeIs('admin.airplanes.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.flights.index') }}"
                   class="nav-item {{ request()->routeIs('admin.flights.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
