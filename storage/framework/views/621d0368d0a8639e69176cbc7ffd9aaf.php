...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid-stats">
        <div class="stat-card">
            ...
            <div class="flex gap-3 mt-3 text-xs">
                <span class="text-green-600 font-semibold"><?php echo e($confirmedBookings); ?> confirmed</span>
                <span class="text-amber-600 font-semibold"><?php echo e($pendingBookings); ?> pending</span>
                <span class="text-red-600 font-semibold"><?php echo e($cancelledBookings); ?> cancelled</span>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($totalFlights); ?></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <a href="<?php echo e(route('admin.airlines.index')); ?>" class="stat-card flex items-center gap-4 !p-4 hover:border-blue-200 transition">
            <div class="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 font-bold text-lg flex-shrink-0"><?php echo e($totalAirlines); ?></div>
            <div>
                <p class="font-bold text-slate-800">Maskapai</p>
                <p class="text-xs text-slate-400">Maskapai terdaftar</p>
            </div>
        </a>
        <a href="<?php echo e(route('admin.airports.index')); ?>" class="stat-card flex items-center gap-4 !p-4 hover:border-blue-200 transition">
            <div class="w-12 h-12 bg-green-50 rounded-lg flex items-center justify-center text-green-600 font-bold text-lg flex-shrink-0"><?php echo e($totalAirports); ?></div>
            <div>
                <p class="font-bold text-slate-800">Bandara</p>
                <p class="text-xs text-slate-400">Bandara terdaftar</p>
            </div>
        </a>
        <a href="<?php echo e(route('admin.airplanes.index')); ?>" class="stat-card flex items-center gap-4 !p-4 hover:border-blue-200 transition">
            <div class="w-12 h-12 bg-purple-50 rounded-lg flex items-center justify-center text-purple-600 font-bold text-lg flex-shrink-0"><?php echo e($totalAirplanes); ?></div>
            <div>
        ...
        <div class="stat-card flex items-center gap-4 !p-4">
            <div class="w-12 h-12 bg-amber-50 rounded-lg flex items-center justify-center text-amber-600 font-bold text-lg flex-shrink-0"><?php echo e($totalUsers); ?></div>
            <div>
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between py-3 border-b border-slate-50 last:border-0">
                        <div>
                            <p class="font-semibold text-slate-800 text-sm"><?php echo e($booking->booking_code); ?></p>
                            <p class="text-xs text-slate-500"><?php echo e($booking->user->name ?? 'N/A'); ?> • <?php echo e($booking->flight->airline->name ?? 'N/A'); ?></p>
                        </div>
                        <div class="text-right">
                            <span class="badge <?php echo e($booking->status_badge['class']); ?>"><?php echo e($booking->status_badge['label']); ?></span>
                            <p class="text-xs text-slate-400 mt-1">Rp<?php echo e(number_format($booking->total_price, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center gap-3 py-3 border-b border-slate-50 last:border-0">
                        <div class="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-xs font-bold text-slate-600 flex-shrink-0">
                            <?php echo e(substr($activity->user->name ?? 'S', 0, 1)); ?>
...
<?php endif; ?><?php /**PATH C:\Users\artaa\Downloads\maskapai-fixed-audit\maskapai-main\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>