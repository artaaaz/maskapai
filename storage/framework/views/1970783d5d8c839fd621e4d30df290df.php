...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-red-950 to-slate-900 flex items-center justify-center p-6">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.login.store')); ?>" id="loginForm" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
</html><?php /**PATH C:\Users\artaa\Downloads\maskapai-fixed-audit\maskapai-main\resources\views/auth/admin/login.blade.php ENDPATH**/ ?>